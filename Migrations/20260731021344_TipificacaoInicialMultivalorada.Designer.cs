...
namespace SIG_Defesa_Civil.API.Migrations
{
    ...
    [Migration("20260731021344_TipificacaoInicialMultivalorada")]
    partial class TipificacaoInicialMultivalorada
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SIG_Defesa_Civil.API.Data.Entities.Tabelas.Ocorrencia.OpcaoCampoVistoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("opcoes_campo_vistoria");
                });
            ...
            modelBuilder.Entity("SIG_Defesa_Civil.API.Data.Entities.Tabelas.Ocorrencia.Vistoria", b =>
                {
                    ...
                    b.Property<List<string>>("AreasAfetadas")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.Property<List<string>>("EncaminhamentosDeCampo")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.Property<List<string>>("Motivacao")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.Property<List<string>>("Orientacoes")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.Property<List<string>>("TipificacaoOcorrencia")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.Property<int?>("Vistoriador3Id")
                        .HasColumnType("integer");

                    b.Property<int?>("Vistoriador4Id")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("Vistoriador3Id");

                    b.HasIndex("Vistoriador4Id");
            ...
            modelBuilder.Entity("SIG_Defesa_Civil.API.Data.Entities.Tabelas.Ocorrencia.Ocorrencia", b =>
                {
                    ...
                    b.OwnsOne("SIG_Defesa_Civil.API.Data.Entities.Tabelas.Ocorrencia.SolicitanteOcorrencia", "Solicitante", b1 =>
                        {
                            ...
                            b1.Property<string>("Celular")
                                .HasMaxLength(50)
                                .HasColumnType("character varying(50)")
                                .HasColumnName("SolicitanteCelular");

                            b1.Property<string>("Cpf")
                                .HasMaxLength(11)
                                .HasColumnType("character varying(11)")
                                .HasColumnName("SolicitanteCpf");
                            ...
                            b1.Property<string>("OrgaoEmissor")
                                ...
                                .HasColumnName("SolicitanteOrgaoEmissor");

                            b1.Property<string>("Rg")
                                .HasMaxLength(20)
                                .HasColumnType("character varying(20)")
                                .HasColumnName("SolicitanteRg");
            ...
            modelBuilder.Entity("SIG_Defesa_Civil.API.Data.Entities.Tabelas.Ocorrencia.Vistoria", b =>
                {
                    ...
                    b.HasOne("SIG_Defesa_Civil.API.Data.Models.Tabelas.Usuario", "Vistoriador3")
                        .WithMany()
                        .HasForeignKey("Vistoriador3Id");

                    b.HasOne("SIG_Defesa_Civil.API.Data.Models.Tabelas.Usuario", "Vistoriador4")
                        .WithMany()
                        .HasForeignKey("Vistoriador4Id");
                    ...
                    b.Navigation("Vistoriador3");

                    b.Navigation("Vistoriador4");
                });
